...
test_that("compare_screen works", {
  ...
  expect_true(grepl("Vínculos repetidos:<br/>&emsp; - Sistec: 1<br/>&emsp; - Qacademico: 43", output_screen))
  expect_true(grepl("Vínculos não encontrados:<br/>&emsp; - Sistec: 528<br/>&emsp; - Qacademico: 3773", output_screen))
  expect_true(grepl("Para inspeção manual:<br/>&emsp; - Sistec: 163<br/>&emsp; - Qacademico: 225", output_screen))
  expect_true(grepl("Erro no cadastro:<br/>&emsp; - Na data de início: 54", output_screen)) 
  expect_true(grepl("Situações comparadas:<br/>&emsp; - Atualizadas: 9466<br/>&emsp; - Desatualizadas: 799", output_screen))
})
